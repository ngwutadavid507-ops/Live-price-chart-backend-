...
async def lifespan(app: FastAPI):
    ...
    asyncio.create_task(start_bybit_ws(market_cache.update_from_ws))
    asyncio.create_task(start_okx_ws(market_cache.update_from_ws))
    asyncio.create_task(start_bingx_ws(market_cache.update_from_ws))
